      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            <h3 className="font-display text-2xl font-bold mb-4">Grace Community Church</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:hello@gracecommunity.org" className="text-primary-foreground/70 hover:text-gold transition-colors">
